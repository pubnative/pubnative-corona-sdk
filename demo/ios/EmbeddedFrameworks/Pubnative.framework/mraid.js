...
//  Copyright (c) 2017 PubNative, Inc. All rights reserved.
//
(function() {
...
mraid.sendSMS = function(url) {
    log.i("mraid.sendSMS " + url);
    callNative("sendSMS?url=" + encodeURIComponent(url));
};
 
mraid.callNumber = function(url) {
 log.i("mraid.callNumber " + url);
 callNative("callNumber?url=" + encodeURIComponent(url));
 };
